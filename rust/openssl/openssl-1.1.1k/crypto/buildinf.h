...
#define DATE "built on: Sat Jun 12 18:19:34 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    't','/','a','n','d','r','o','i','d','-','s','d','k','/','a','n',
    'd','r','o','i','d','-','n','d','k','-','r','2','1','e','/','t',
    'o','o','l','c','h','a','i','n','s','/','a','a','r','c','h','6',
    '4','-','l','i','n','u','x','-','a','n','d','r','o','i','d','-',
    '4','.','9','/','p','r','e','b','u','i','l','t','/','l','i','n',
    'u','x','-','x','8','6','_','6','4',' ','-','-','s','y','s','r',
    'o','o','t','=','/','o','p','t','/','a','n','d','r','o','i','d',
    '-','s','d','k','/','a','n','d','r','o','i','d','-','n','d','k',
    '-','r','2','1','e','/','p','l','a','t','f','o','r','m','s','/',
    'a','n','d','r','o','i','d','-','3','0','/','a','r','c','h','-',
    'a','r','m','6','4',' ','-','W','a',',','-','-','n','o','e','x',
    ...
    '3','0','5','_','A','S','M',' ','-','D','_','_','A','N','D','R',
    'O','I','D','_','A','P','I','_','_','=','3','0',' ','-','i','s',
    'y','s','t','e','m',' ','/','o','p','t','/','a','n','d','r','o',
    'i','d','-','s','d','k','/','a','n','d','r','o','i','d','-','n',
    'd','k','-','r','2','1','e','/','s','y','s','r','o','o','t','/',
    'u','s','r','/','i','n','c','l','u','d','e','/','a','a','r','c',
    'h','6','4','-','l','i','n','u','x','-','a','n','d','r','o','i',
    'd',' ','-','i','s','y','s','t','e','m',' ','/','o','p','t','/',
    'a','n','d','r','o','i','d','-','s','d','k','/','a','n','d','r',
    'o','i','d','-','n','d','k','-','r','2','1','e','/','s','y','s',
